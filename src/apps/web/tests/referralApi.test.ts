...
test('referral money states have complete Traditional Chinese runtime copy', () => {
  ...
  assert.deepEqual(
    ['佣金', '累计佣金', '充值与佣金流水', '佣金冻结、退款追回和提现状态均以平台资金账本为准。', '后续佣金将优先抵扣', '已得佣金', '佣金比例', '原始佣金', '净佣金'].map(localizeText),
    ['傭金', '累計傭金', '充值與傭金流水', '傭金凍結、退款追回和提現狀態均以平台資金帳本為準。', '後續傭金將優先抵扣', '已得傭金', '傭金比例', '原始傭金', '淨傭金'],
  )
