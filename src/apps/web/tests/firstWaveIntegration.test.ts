...
test('personal paper ticket preserves explicit confirmation and safe retry identity', () => {
  ...
  assert.match(paperStyles, /--paper-ai-text: var\(--brand-blue\)/)
  assert.match(paperStyles, /--paper-control-border: var\(--border-strong\)/)
  assert.match(paperStyles, /--paper-gradient: linear-gradient\(90deg, var\(--brand-blue\) 0%, var\(--brand-violet\) 100%\)/)
