...
export function AdminPage() {
  ...
  return <div className="page operations-page admin-page">
    ...
    <section className="data-panel admin-panel admin-withdrawals" aria-labelledby="admin-withdrawals-title">
