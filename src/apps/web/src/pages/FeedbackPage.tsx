  ...
  return <div className="page operations-page feedback-page">
    ...
    <div className="feedback-layout">
      <form className="data-panel feedback-form" onSubmit={submit} aria-busy={submitting}>
        ...
        <label><span>问题页面</span><input value={page} onChange={(event) => setPage(event.target.value)} name="page" autoComplete="off" placeholder="/markets" /><small>仅记录页面路径，不收集搜索内容或账户资料。</small></label>
