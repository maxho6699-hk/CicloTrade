...
interface ResearchCopy {
  title: string; subtitle: string; disclaimer: string; loading: string; error: string; forbidden: string; partial: string; mismatch: string; empty: string; noMatches: string; waiting: string
