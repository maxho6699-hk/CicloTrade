...
平台可因安全、合规、数据授权或服务维护暂停部分能力。涉及自动交易时，用户必须主动连接并授权个人券商账户，完成券商适当性检查、风险设置与技术联调；会员订阅不会自动授予真实交易权限。企业 API 或私有部署按独立服务范围启用。客服：Telegram @Maxooo8（https://t.me/Maxooo8），邮箱 support@ciclotrade.com。""",
    ),
    (
        "隐私政策",
        "数据最小化与账户安全",
