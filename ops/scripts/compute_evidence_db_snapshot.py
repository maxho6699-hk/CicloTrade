...
MAIN_TABLES = (
    ...
    TableSpec("trades"),
    TableSpec("risk_log"),
    TableSpec("strategy_action_logs"),
    TableSpec("user_action_logs"),
    TableSpec("broker_accounts"),
    TableSpec("account_snapshots"),
    TableSpec("system_events"),
    TableSpec("platform_controls"),
    TableSpec("user_controls"),
    TableSpec("strategy_performance"),
    TableSpec("notifications"),
    TableSpec("quant_events"),
    TableSpec("quant_event_legs"),
    TableSpec("quant_equity_snapshots"),
